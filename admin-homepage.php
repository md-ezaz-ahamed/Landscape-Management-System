							...
							<div class="item">
								<div class="wrap">
									...
									<div class="text p-4 float-right d-block">
										...
										<h3 class="heading mb-0"><a href="">Previously done project for a Resort</a></h3>
										<p>This project was done in Chittagong near to the Naval Port a resort was built where our landscapping service was taken.</p>
							...
							<div class="item">
								<div class="wrap">
									...
									<div class="text p-4 float-right d-block">
										...
										<h3 class="heading mb-0"><a href="">Previously done project for a Bunglow</a></h3>
										<p>Famous industrialist, Tasin Rahman, took our service to renovate the garden of his personal farmhouse. </p>
							...
							<div class="item">
								<div class="wrap">
									...
									<div class="text p-4 float-right d-block">
										...
										<h3 class="heading mb-0"><a href="">Previously done project for a Residential area</a></h3>
										<p>The garden created in the Bashundhara R/A wa design and completed through our service.</p>
							...
							<div class="item">
								<div class="wrap">
									...
									<div class="text p-4 float-right d-block">
										...
										<h3 class="heading mb-0"><a href="">Previously done project for a Eco Resort</a></h3>
										<p>This was the design done for the eco resort of sylhey named 'Dusai'which is a 5 star eco resort.</p>
